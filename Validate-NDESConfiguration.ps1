...
##Updated by Matt Hinson for latest Intune Certificate Connector version
...
Write-host "......................................................."
Write-host
Write-Host "Checking NDES Client certificate is valid for use..." -ForegroundColor Yellow
#Write-host
Log-ScriptEvent $LogFilePath "Checking Client certificate is valid for use" NDES_Validation 1
...
$NDESConnector = "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\MicrosoftIntune\PFXCertificateConnector"
...
#$SigningCertificate = "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\MicrosoftIntune\NDESConnector\SigningCertificate"
    ...
    if (-not ($NDESConnector)){

        Write-host "Error: The Intune NDES Connector registry key does not exist." -BackgroundColor Red
        Write-Host
        Log-ScriptEvent $LogFilePath "The Intune NDES Connector registry key does not exist."  NDES_Validation 3 
                ...
                Write-Host "Success: " -ForegroundColor Green -NoNewline
                Write-Host "Intune NDES Connector registry key exists!"
                Log-ScriptEvent $LogFilePath "Intune NDES Connector registry key exists!"  NDES_Validation 1
